...
VL_ATTR_COLD void VSimpleCpu___024root___ctor_var_reset(VSimpleCpu___024root* vlSelf) {
    ...
    vlSelf->SimpleCpu__DOT__DecoderModule__DOT___DecoderOut_T_7 = VL_RAND_RESET_I(3);
    vlSelf->SimpleCpu__DOT__DecoderModule__DOT___DecoderOut_T_9 = VL_RAND_RESET_I(2);
    vlSelf->SimpleCpu__DOT__DecoderModule__DOT___DecoderOut_T_20 = VL_RAND_RESET_I(3);
