...
VL_INLINE_OPT void VSimpleCpu___024root___nba_sequent__TOP__0(VSimpleCpu___024root* vlSelf) {
    ...
    vlSelf->SimpleCpu__DOT__PcReg = ((IData)(vlSelf->reset)
                                      ? 0x80000000U
                                      : ((0U != (IData)(vlSelf->SimpleCpu__DOT__DecoderModule__DOT___DecoderOut_orMatrixOutputs_T_9))
                                          ? vlSelf->SimpleCpu__DOT__PcInc
                                          : vlSelf->SimpleCpu__DOT__PcBr));
    if ((IData)(((0xf00U == (0xf80U & vlSelf->Fetch_Inst)) 
                 & (0U != (IData)(vlSelf->SimpleCpu__DOT__DecoderModule__DOT___DecoderOut_orMatrixOutputs_T_7))))) {
        vlSelf->SimpleCpu__DOT__RF__DOT__gprSeq_30 
...
#endif
            VL_FATAL_MT("build/SimpleCpu.v", 2964, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("build/SimpleCpu.v", 2964, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("build/SimpleCpu.v", 2964, "", "Active region did not converge.");
            }
