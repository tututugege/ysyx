...
### java.lang.StringIndexOutOfBoundsException: offset 2839, count -13, length 4276
...
class Multiplier extends Module {
  ...
  val lastSel = WireInit(0.U(3.W))

  for (i <- Range(0, 32, 2)) {
    val sel = y0(i * 2 + 2, i * 2)
    val ppTemp = MuxLookup(sel, 0.U)(
      Seq(
        1.U -> extX,
        2.U -> extX,
        3.U -> (extX << 1),
