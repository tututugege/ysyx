file://<WORKSPACE>/src/main/3.EX/EXU.scala
### scala.ScalaReflectionException: value divCompelete is not a method
...
action parameters:
offset: 2547
uri: file://<WORKSPACE>/src/main/3.EX/EXU.scala
text:
```scala
import chisel3._
...
class EXU(XLEN: Int) extends Module {
  ...
  // Divider
  Div.io.div    := (in.aluOp === AluOpDiv.U) && io.inValid
  Div.io.signed := ~in.func3(0)
  Div.io.x      := data1
  Div.io.y      := data2

  val divCompelete = Div.io.div && Div.io.complete || @@
