...
module EF_PSRAM_CTRL_wb (
    ...
    wire [7:0] cmd_swt = 8'h35;
    wire [3:0] dout_swt = {3'b0, cmd_swt[3'd7 - counter[2:0]]};
    ...
    assign sck  = rst_swt ? sck_swt : wb_we ? mw_sck  : mr_sck;
    assign ce_n = rst_swt && ~rst_i ? 1'b0 : wb_we ? mw_ce_n : mr_ce_n;
    assign dout = rst_swt ? dout_swt : wb_we ? mw_dout : mr_dout;
    assign douten = rst_swt ? 4'b1111 : wb_we ? {4{mw_doe}}  : {4{mr_doe}};
