...
class sdramChisel extends RawModule {
  ...
  withClockAndReset(io.clk.asClock, io.cke) {
    ...
    val sramLo = Module(new chipChisel)
    val sramHi = Module(new chipChisel)

    val dout = Wire(UInt(32.W))
    val din  = TriStateInBuf(io.dq, dout, sramLo.io.valid || sramHi.io.valid)

    sramLo.io.cmd := write ## read
    sramLo.io.a   := io.a(12, 0)
    sramLo.io.ba  := io.ba
    sramLo.io.dqm := io.dqm(1, 0)
    sramLo.io.din := din(15, 0)

    sramHi.io.we  := wr@@
    sramHi.io.a   := io.a
    sramHi.io.ba  := io.ba
    sramHi.io.dqm := io.dqm(3, 2)
    sramHi.io.din := din(31, 16)

    dout := sramHi.io.dout ## sramLo.io.dout
...
scala.collection.mutable.ArrayBuffer.apply(ArrayBuffer.scala:106)
	...
	scala.tools.nsc.typechecker.Typers$Typer.adaptToName(Typers.scala:1397)
	...
	scala.tools.nsc.typechecker.Typers$Typer.$anonfun$typed1$62(Typers.scala:5349)
	scala.tools.nsc.typechecker.Typers$Typer.silent(Typers.scala:712)
	scala.tools.nsc.typechecker.Typers$Typer.typedSelect$1(Typers.scala:5349)
	...
	scala.reflect.internal.Symbols$Symbol.completeInfo(Symbols.scala:1563)
	scala.reflect.internal.Symbols$Symbol.info(Symbols.scala:1535)
	scala.reflect.internal.Symbols$Symbol.tpeHK(Symbols.scala:1489)
	...
	scala.tools.nsc.interactive.Global$Members.$anonfun$add$1(Global.scala:1014)
	scala.tools.nsc.interactive.Global$OnTypeError.onTypeError(Global.scala:1387)
	scala.tools.nsc.interactive.Global$Members.add(Global.scala:1014)
	scala.tools.nsc.interactive.Global.addScopeMember$1(Global.scala:1043)
	scala.tools.nsc.interactive.Global.$anonfun$scopeMembers$3(Global.scala:1071)
	scala.tools.nsc.interactive.Global.$anonfun$scopeMembers$3$adapted(Global.scala:1070)
	scala.reflect.internal.Scopes$Scope.foreach(Scopes.scala:455)
	scala.tools.nsc.interactive.Global.scopeMembers(Global.scala:1070)
	scala.tools.nsc.interactive.Global.completionsAt(Global.scala:1284)
